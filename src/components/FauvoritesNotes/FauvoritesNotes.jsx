...
import './FauvoritesNotes.css';

function FauvoritesNotes() {
            ...
            <div className='full-height bg-dark-2'>
                {
                    ...
                    <div className="saveds-container">
                        <div className='saveds-title'>
                            <h3>Your fauvorites studies notes...</h3>
                        </div>
                    ...
                    <div className="saveds-container">
                        <div className='saveds-title'>
                            <h3>You don't have fauvorites notes yet...</h3>
                        </div>
                        <div className='notes-saveds-container'>
...
export default FauvoritesNotes;
